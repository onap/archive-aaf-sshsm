...
# 4.a Copy the required input files for the Import tool
cp ${duplicatetooldir}/* /sshsm/tpm-util/initandverify

# 4.b Run the Import Utility
cd /sshsm/tpm-util/initandverify
./ImportTpmKey.sh

# 4.c Copy the output of the Import utility to the directory that SoftHSMv2 expects
...
# 5. Create the configuration pkcs11.cfg for the application
