...
public class CaSignMultiThread {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i<thread_Count; i++) {
            ...
            String command = "openssl req -nodes -sha1 -newkey rsa:2048 -keyout " + "Thread" + Integer.toString(i) + ".key -out " + "Thread" + Integer.toString(i) + ".csr -days 365 -subj  \"/C=US/ST=CA/L=SantaClara/O=ONAP/CN=<name>\"";
            System.out.println(command);
            try {

                Process p0 = Runtime.getRuntime().exec(command);
                BufferedReader stdInput = new BufferedReader(new
            ...
            for (int i = 0; i<thread_Count; i++) {
                ...
                String command1 = "openssl verify -verbose -CAfile ca.cert " + "Thread" + Integer.toString(i) + ".cert";
                try {
