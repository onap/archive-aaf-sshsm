Create folder under /tmp/volume/host_<host name> for each host (example host_sample where sample is the name of the tpm capable host).
...
Encrypted priviate key and certificate under /tmp/volume
