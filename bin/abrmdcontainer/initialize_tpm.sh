...
# 1.a Environmental variable for SRK Handle file
srkhandle="0x81000011"
# 1.b Password for the TPM's Primary key and it's operations
password="new"
# 1.c Location of Shared volume
export sharedvolume="/tmp/files/inittoolfiles"

# 1.d Create the directory with the host's name to store the output of Init tool
