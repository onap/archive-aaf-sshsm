...
SRKHANDLE="$(cat /abrmd/cred/srk_handle)"
TPMPASSWD="$(cat /abrmd/cred/tpm_pass)"
...
# 7. Copy the public portion of the Primary key to the Shared volume
# Use environment variable TPM_NODE_NAME
cp out_primary_public ${WORKDIR}
