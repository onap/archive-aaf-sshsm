               ...
               unsigned char *key_label, void *key_handle)
{
    ...
    unsigned long int key_id_int = atoi(key_id );
    ...
    CK_ATTRIBUTE keyTemplate[] = {
        ...
        { CKA_EXPONENT_2,       0,                  0},
        { CKA_COEFFICIENT,      0,                  0},
        { CKA_OS_PRIVATE_HANDLE,       (CK_ULONG) *((CK_ULONG*)key_handle),      sizeof(CK_ULONG) }
    };
    ...
    if (ulObjectCount != 0) {
        ...
        LOG("PrepareKeyInSoftHSM: Object already exists\n");
    }
