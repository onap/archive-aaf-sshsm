...
/*
    ...
    sessionsDataOut.auths[0] = sessionDataOutArray[0];
    sessionsData.auths[0] = sessionDataArray[0];

    sessionsDataOut.auths[] = 1;
    sessionsData.auths[] = 1;
*/
