...
class ThreadDemo extends Thread {
    ...
    public void run() {
        ...
        sw.write("\n-----END CERTIFICATE-----\n");
        FileWriter fw = new FileWriter("/tmp/"+ threadName +".cert");
        fw.write(sw.toString());
        fw.close();
        System.out.println("Done - Signed certificate at /tmp/"+ threadName  +".cert");

        String command1 = "openssl verify -verbose -CAfile ca.cert /tmp/" + threadName + ".cert";
        try {
